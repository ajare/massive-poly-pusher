...
5. **Automatic layout — COMPLETE**
   - [x] Build the horizontally centred vertical execution spine with inline enabled/bypassed AA stages, left-side pass-owned batch children joined by straight directed connectors, disabled-authored-pass/resource columns, and named-output branches.
