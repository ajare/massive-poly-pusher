...
class BulletsQuadBatchDataProvider : public mpp::helper::QuadBatchDataProvider<mpp::mesh::DataTypeFloat, mpp::mesh::DataTypeFloat>
{
	struct Bullet
	{
		Vector2 pos;
...
public:
	...
	BulletsQuadBatchDataProvider(int x, int y, int width, int height, size_t count)
		: mX(x)
		, mY(y)
		, mWidth(width)
		, mHeight(height)
