...
void ModelScene::createBatches(mpp::RenderSystem* renderSystem)
{
	...
	mBatches.push_back(getScene()->add2dBatch(quadBatchDataProvider4, quadBatchRenderer4, 100));
...
mpp::CameraPtr ModelScene::createCamera(ProgramOptions const& options) const
{
	...
	auto camera = new helper::FreeCamera(glm::vec3(0, 150, 550), 180.0f, 0.0f, 0.0f, 45.0f, aspectRatio);
