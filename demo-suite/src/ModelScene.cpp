...
void ModelScene::teardownImpl()
{
	...
	mBatch3dMaterial->release();
	mBulletsMaterial->release();
	mBoxMaterial->release();
	mSphereMaterial->release();
	mCylinderMaterial->release();
	mTorusMaterial->release();
	mGridMaterial->release();
}
