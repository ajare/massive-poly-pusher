...
namespace mpp::resource_parsers
{
	...
	LegacyPipelineDocument LegacyPipelineParser::fromFile(string const& filepath)
	{
		...
		rejectUnknown(data,{"version","name","PreviewScene","ResourceLibraries","LocalResources","Imports","Outputs","Bloom","AmbientOcclusion","SSAO","PreviewBindings","PreviewOverrides","Extensions","RenderGraph"},"LegacyPipeline");
