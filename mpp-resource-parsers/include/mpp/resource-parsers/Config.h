...
#	if defined(MPP_RESOURCE_PARSERS_DLL_EXPORT)
#		define _MPPRESOURCEPARSERSAPI __declspec( dllexport )
#	elif defined(MPP_RESOURCE_PARSERS_STATIC_LIB)
#		define _MPPRESOURCEPARSERSAPI
#	else
#		if defined(__MINGW32__)
#			define _MPPRESOURCEPARSERSAPI
#		else
#			define _MPPRESOURCEPARSERSAPI __declspec( dllimport )
#		endif
#	endif
#elif MPP_PLATFORM == MPP_PLATFORM_LINUX
#	if defined(MPP_RESOURCE_PARSERS_DLL_EXPORT)
#		define _MPPRESOURCEPARSERSAPI __attribute__((visibility("default")))
#	else
#		define _MPPRESOURCEPARSERSAPI
#	endif
#endif
