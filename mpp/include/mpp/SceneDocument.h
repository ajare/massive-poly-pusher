...
struct _MPPAPI SceneLightDocument { std::string id; SceneLightType type{SceneLightType::Directional}; glm::vec3 colour{1}; float intensity{1}; glm::vec3 position{0}; glm::vec3 direction{0,-1,0}; float range{0}; };
