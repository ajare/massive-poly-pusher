...
#define WP_PI				3.14159265359f
#define WP_TWOPI			(WP_PI * 2)
#define WP_RADTODEG(angle)	(angle * 360 / WP_TWOPI)
#define WP_DEGTORAD(angle)	(angle * WP_TWOPI / 360)
...
public:
	...
	inline Vector2 rotatedCopy(float angle)
	{
		float angleRadians = WP_DEGTORAD(angle);
